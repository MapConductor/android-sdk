...
class MapLibreMarkerController(
    ...
    override suspend fun add(data: List<MarkerState>) {
        semaphore.withPermit {
            ...
            val updated = mutableListOf<MarkerOverlayRendererInterface.ChangeParamsInterface<MapLibreActualMarker>>()
            val removedActualMarkers = mutableListOf<MarkerEntityInterface<MapLibreActualMarker>>()
            ...
            data.forEach { state ->
                ...
                if (previousIds.contains(state.id)) {
                    ...
                    if (wantsTiled) {
                        ...
                        updated.add(
                            object :
                                MarkerOverlayRendererInterface.ChangeParamsInterface<MapLibreActualMarker> {
