export const BOM_MODULE_VERSION = '1.1.2';
export const CORE_MODULE_VERSION = '1.1.2';
export const ARCGIS_MODULE_VERSION = '1.1.2';
export const GOOGLEMAPS_MODULE_VERSION = '1.1.2';
export const HERE_MODULE_VERSION = '1.1.2';
export const MAPBOX_MODULE_VERSION = '1.1.2';
export const MAPLIBRE_MODULE_VERSION = '1.1.2';
