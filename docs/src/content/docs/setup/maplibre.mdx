...
<ProviderVerificationExample
  provider="MapLibreMap"
  functionName="TestMapLibre"
  comment="If this displays correctly, your setup is working"
  imageUrl="~/assets/setup/basic-setup-maplibre.png"
  extraParams='        styleUrl = "https://tiles.openfreemap.org/styles/liberty"'
/>
