...
description: MapConductor Android SDK setup — prerequisites and installation steps for each supported map provider.
---
...
Once each map SDK is initialized, MapConductor only needs the corresponding `MapViewStateInterface` and map view component.
