...
<CompatibilityAwareMapExample
  ...
  long={-122.4194}
  mapProvider="MapView"
  comment="Replace MapView with your chosen map provider, such as GoogleMapView, MapboxMapView"
  alwaysSupportedComment="Always supported components"
  conditionallySupportedComment="Conditionally supported components"
/>
