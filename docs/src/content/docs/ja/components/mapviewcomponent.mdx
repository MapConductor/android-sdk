...
description: MapConductor Android SDKのプロバイダ別Jetpack Composeマップビュー — Google Maps、Mapbox、HERE、ArcGIS、MapLibre対応。
---
...
MapViewComponentの中にはMapViewを制御するためのコントロールが内包されています。このコントロールは`MapViewStateInterface`を通じて操作することができます。
