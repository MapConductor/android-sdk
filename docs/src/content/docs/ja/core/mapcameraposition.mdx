---
title: "MapCameraPositionInterface（カメラ位置）"
description: MapCameraPosition — MapConductor Android SDKでマップの中心・ズーム・チルト・方向を設定する方法。
---
...
<BearingExamples
  ...
  bearingEast={90.0}
  bearingRoute={135.0}
  northUpComment="北向き（デフォルト）"
  eastUpComment="東向き"
  followingBearingComment="ルートの方位角に従う"
  routeComment="南東"
/>
...
<TiltExamples
  ...
  streetBearing={45.0}
  streetZoom={19.0}
  topDownComment="真上からの眺め（デフォルト）"
  angledComment="奥行きを出すための傾斜"
...
<VisibleRegionDataClass
  boundsComment="全体の境界矩形"
  nearLeftComment="左下角（カメラに近い側）"
  nearRightComment="右下角（カメラに近い側）"
  farLeftComment="左上角（カメラから遠い側）"
  farRightComment="右上角（カメラから遠い側）"
/>
