...
### Marcador combinado con InfoBubble

Combinando el marcador con el componente `InfoBubble`, puedes mostrar información detallada cuando se hace clic en un marcador. Para más detalles, consulta el [componente InfoBubble](/es-419/components/infobubble).
