...
MapViewComponent contiene controles para gestionar MapView. Estos controles se pueden manipular a través de `MapViewState`.
...
- **`markerRenderingStrategy`**: Estrategia de renderizado de marcador personalizado para optimización de rendimiento
