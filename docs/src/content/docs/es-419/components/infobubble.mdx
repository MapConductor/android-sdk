---
title: "InfoBubble"
description: Muestra ventanas de información ancladas a marcadores usando InfoBubble en MapConductor Android SDK.
---
...
### Gestión de Múltiples Burbujas

<MultipleBubblesExample
  commentForMapViewUsage="Reemplace MapView con el proveedor de mapas que elija, como GoogleMapView o MapboxMapView"
  commentForTapToClose="Toque para cerrar"
...
<RightInfoBubbleMapExample
  ...
  commentForInteractiveMarkers="Contenido de mapa con marcadores interactivos"
  commentForSelectedMarkerInfo="Mostrar información del marcador seleccionado"
  commentForRightSideTailExample="Burbuja personalizada con cola en el lado derecho"
/>
