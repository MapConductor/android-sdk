...
description: MarkerNativeStrategy — usa renderizado nativo de marcadores para mejor rendimiento en MapConductor Android SDK.
---
...
Las estrategias nativas siguen necesitando un renderer/controller específico del proveedor para mostrar resultados en el mapa.
Los módulos incluidos lo proporcionan mediante el sistema de capabilities de `MapServiceRegistry` (ver [Map Service Registry](/es-419/core/service-registry/)).
