---
title: "CircleState"
description: CircleState — actualiza dinámicamente el radio, relleno y borde de un círculo en MapConductor Android SDK.
---
...
<InteractiveCircleExampleComposable
  ...
  circleClickLog="Círculo pulsado en: ${event.clicked}"
/>
