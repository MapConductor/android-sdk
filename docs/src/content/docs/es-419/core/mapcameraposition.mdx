...
1. **Selección de Nivel de Zoom**: Elige niveles de zoom apropiados para tu caso de uso.
2. **Transiciones Suaves**: Usa movimientos de cámara graduales para una mejor experiencia de usuario.
3. **Gestión de Paddings**: Ten en cuenta elementos de UI al establecer la posición de la cámara.
4. **Rendimiento**: Evita cambios de posición de cámara demasiado frecuentes que provoquen redibujos costosos.
5. **Contexto del Usuario**: Considera qué necesita ver el usuario al establecer la posición inicial de la cámara.
6. **Accesibilidad**: Proporciona controles para usuarios que no puedan usar gestos para mover la cámara.

## Casos de uso comunes

### Foco en la ubicación del usuario

<UserLocationCameraExample
  commentForZoom="Detalle a nivel de calle"
  zoomLevel={16.0}
/>

### Mostrar múltiples puntos

<ShowMultiplePointsExample commentForZoomCalculation="Cálculo personalizado de zoom" />
...
<NavigationCameraExample
  navigationZoom={18.0}
  navigationTilt={60.0}
  commentForBearing="Dirección de viaje"
/>
