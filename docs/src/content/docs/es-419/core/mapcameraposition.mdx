...
- **`paddings: MapPaddings?`**: Márgenes del viewport que afectan a la región visible. **Nota: esta propiedad aún no funciona en v{BOM_MODULE_VERSION}**.
...
- **`nearLeft: GeoPoint?`**: Coordenada geográfica de la esquina inferior izquierda de la región visible.
- **`nearRight: GeoPoint?`**: Coordenada geográfica de la esquina inferior derecha.
- **`farLeft: GeoPoint?`**: Coordenada geográfica de la esquina superior izquierda.
- **`farRight: GeoPoint?`**: Coordenada geográfica de la esquina superior derecha.
