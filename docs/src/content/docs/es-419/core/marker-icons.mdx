...
1. **Escalado consistente**: Usa valores de escala coherentes en toda la aplicación.
2. **Paleta de colores**: Mantén una paleta de colores consistente para tipos de marcador.
3. **Puntos de anclaje**: Usa anclajes apropiados para cada tipo de icono (inferior centrado para pines, centrado para círculos).

### Accesibilidad

1. **Etiquetas significativas**: Proporciona etiquetas descriptivas al usar `DefaultIcon`.
2. **Contraste de color**: Asegura buen contraste entre colores de relleno y borde.
3. **Indicadores alternativos**: No dependas únicamente del color para transmitir información.
