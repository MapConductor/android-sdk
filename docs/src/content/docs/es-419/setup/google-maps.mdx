...
description: Guía paso a paso para configurar Google Maps como proveedor en MapConductor Android SDK.
---
...
<AppGradleTabs
  ...
  googleMapsSdkComment="Google Maps SDK (versión gestionada mediante libs.versions.toml)"
...
/>
![Resultado de TestGoogleMaps](~/assets/setup/basic-setup-google.png)
