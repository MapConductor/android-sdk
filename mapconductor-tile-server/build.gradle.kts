...
android {
    namespace = "com.mapconductor.tileserver"
...
val libraryArtifactId = "tile-server"
val libraryVersion = project.findProperty("libraryVersion") as String? ?: "1.0.0"

// Set project version for NMCP plugin
version = libraryVersion
val libraryName = "MapConductor Tile Server"
val libraryDescription = "Local tile server for MapConductor raster overlays"
